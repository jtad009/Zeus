...
<div class="projects view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= h($project->topic) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Staff') ?></th>
            <td><?= $project->has('staff') ? $this->Html->link($project->staff->id, ['controller' => 'Staffs', 'action' => 'view', $project->staff->id]) : '' ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Expected Completion Date') ?></th>
            <td><?= h($project->expected_completion_date) ?></td>
        </tr>
    </table>
    <div class="row">
        <h4><?= __('Completed') ?></h4>
        <?= $this->Text->autoParagraph(h($project->completed)); ?>
    </div>
    <div class="row">
        <h4><?= __('Status') ?></h4>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($project->students as $students): ?>
            <tr>
                <td><?= h($students->id) ?></td>
