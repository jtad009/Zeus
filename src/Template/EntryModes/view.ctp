...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Entry Mode'), ['action' => 'edit', $entryMode->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Entry Mode'), ['action' => 'delete', $entryMode->id], ['confirm' => __('Are you sure you want to delete # {0}?', $entryMode->id)]) ?> </li>
...
<div class="entryModes view large-9 medium-8 columns content">
    <h3><?= h($entryMode->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($entryMode->students)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($entryMode->students as $students): ?>
            <tr>
                <td><?= h($students->id) ?></td>
